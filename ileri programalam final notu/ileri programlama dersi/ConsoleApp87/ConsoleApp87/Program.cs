...
namespace ConsoleApp87
{
        ...
        class Program
        {
            ...
            {
                personel[] işçiler = { // [] dizi tanımlanacaıpğı zamna bu parantez kullanılır 
                ...
                foreach (var eleman in işçiler) // foreach dizi tipi elemanları yazarken değerleri daha koaly aktarmak için yazar 
